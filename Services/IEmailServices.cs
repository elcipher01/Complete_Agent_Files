...
namespace NextHorizon.Services
{
    public interface IEmailService
    {
        ...
        Task<bool> SendFinanceRequestStatusEmailAsync(string email, string recipientName, string requestType, string itemName, string status, string note, string adminName);
        ...
        Task<bool> SendAdminPasswordChangedEmailAsync(string email, string fullName, string adminName);
