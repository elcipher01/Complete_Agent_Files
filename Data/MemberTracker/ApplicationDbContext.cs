...
using NextHorizon.Models.Messaging;
using NextHorizon.Models.MemberTracker;
...
public class ApplicationDbContext : DbContext
{
    ...
    public DbSet<NextHorizon.Models.HelpCenter.SupportMessage> SupportMessages => Set<NextHorizon.Models.HelpCenter.SupportMessage>();
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        var supportMessage = builder.Entity<NextHorizon.Models.HelpCenter.SupportMessage>();
        ...
        notification.Property(x => x.NotificationId).HasColumnName("NotificationId");
        notification.Property(x => x.RecipientType).HasColumnName("RecipientType").IsRequired();
        notification.Property(x => x.RecipientId).HasColumnName("RecipientId").IsRequired();
        notification.Property(x => x.OrderId).HasColumnName("OrderId");
        notification.Property(x => x.Message).HasColumnName("Message").IsRequired();
        notification.Property(x => x.IsRead).HasColumnName("IsRead").IsRequired();
        notification.Property(x => x.CreatedAt).HasColumnName("CreatedAt").HasColumnType("datetime2").IsRequired();
        notification.Property(x => x.Category).HasColumnName("category").IsRequired();
